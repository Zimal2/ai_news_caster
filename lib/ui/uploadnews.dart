          ...
          child: Column(
            ...
            children: [
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(
                        10.0), // Adjust the radius for desired roundness
                    borderSide:
                        BorderSide(color: Colors.grey), // Focused border color
                  ),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(
                        10.0), // Adjust the radius for desired roundness
                    borderSide: BorderSide(
                        color: Colors.grey), // Enabled (inactive) border color
                  ),
                ),
              ),
              SizedBox(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 50,
                      child:
                          Image.asset("lib/assests/images/chatpgt icon 1.png"),
                    ),
              ...
              DropdownButton<String>(
                ...
                style: TextStyle(
                    color:
                        Colors.grey), // Set dropdown button text color to grey
                underline: Container(
                  height: 2,
